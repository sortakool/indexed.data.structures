...
public class ItchParser {
    ...
    public ItchParser() throws Exception {
        ...
        ByteOrder byteOrder = fileBuffer.getByteOrder();
        fileBuffer.setByteOrder(MappedFileBuffer.NATIVE_BYTE_ORDER);
...
current registration status in the issue
    ...
    public static void main(String[] args) throws Exception {
        ItchParser paser = new ItchParser();
    }
}
