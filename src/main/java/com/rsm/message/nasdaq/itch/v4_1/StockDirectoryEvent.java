...
public class StockDirectoryEvent
{
    public static final int BLOCK_LENGTH = 54;
    public static final int TEMPLATE_ID = 2082;
    public static final int SCHEMA_ID = 2;
    public static final int SCHEMA_VERSION = 0;

    private final StockDirectoryEvent parentMessage = this;
    ...
    public StockDirectoryEvent wrapForEncode(final DirectBuffer buffer, final int offset)
    {
        this.buffer = buffer;
        this.offset = offset;
    ...
    public StockDirectoryEvent wrapForDecode(final DirectBuffer buffer, final int offset, final int actingBlockLength, final int actingVersion)
    {
        this.buffer = buffer;
        this.offset = offset;
    ...
    public StockDirectoryEvent sequence(final long value)
    {
    ...
    public StockDirectoryEvent messageType(final ITCHMessageType value)
    {
    ...
    public StockDirectoryEvent nanoseconds(final long value)
    {
    ...
    public StockDirectoryEvent putStock(final byte[] src, final int srcOffset)
    {
        final int length = 8;
    ...
    {
        return CodecUtil.charGet(buffer, offset + 47);
    }

    public StockDirectoryEvent marketCategory(final byte value)
    {
        CodecUtil.charPut(buffer, offset + 47, value);
        return this;
    }
    ...
    public StockDirectoryEvent financialStatusIndicator(final byte value)
    {
    ...
    {
        return CodecUtil.uint32Get(buffer, offset + 49, java.nio.ByteOrder.BIG_ENDIAN);
    }

    public StockDirectoryEvent roundLotSize(final long value)
    {
        CodecUtil.uint32Put(buffer, offset + 49, value, java.nio.ByteOrder.BIG_ENDIAN);
        return this;
    }
    ...
    {
        return YesNoType.get(CodecUtil.charGet(buffer, offset + 53));
    }

    public StockDirectoryEvent roundLotsOnly(final YesNoType value)
    {
