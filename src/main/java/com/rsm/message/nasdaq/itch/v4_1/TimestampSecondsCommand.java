...
public class TimestampSecondsCommand
{
    public static final int BLOCK_LENGTH = 31;
    public static final int TEMPLATE_ID = 1084;
    public static final int SCHEMA_ID = 2;
    public static final int SCHEMA_VERSION = 0;

    private final TimestampSecondsCommand parentMessage = this;
    ...
    public TimestampSecondsCommand wrapForEncode(final DirectBuffer buffer, final int offset)
    {
        this.buffer = buffer;
        this.offset = offset;
    ...
    public TimestampSecondsCommand wrapForDecode(final DirectBuffer buffer, final int offset, final int actingBlockLength, final int actingVersion)
    {
        this.buffer = buffer;
        this.offset = offset;
    ...
    public TimestampSecondsCommand messageType(final ITCHMessageType value)
    {
    ...
    public TimestampSecondsCommand seconds(final long value)
    {
