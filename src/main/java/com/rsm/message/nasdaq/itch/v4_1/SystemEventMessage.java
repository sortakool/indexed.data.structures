...
public class SystemEventMessage
{
    ...
    public static final int TEMPLATE_ID = 83;
    public static final int SCHEMA_ID = 2;
    public static final int SCHEMA_VERSION = 0;

    private final SystemEventMessage parentMessage = this;
    ...
    public SystemEventMessage wrapForEncode(final DirectBuffer buffer, final int offset)
    {
        this.buffer = buffer;
        this.offset = offset;
    ...
    public SystemEventMessage messageType(final ITCHMessageType value)
    {
    ...
    public SystemEventMessage timestamp(final long value)
    {
    ...
    {
        return CodecUtil.charGet(buffer, offset + 5);
    }

    public SystemEventMessage eventCode(final byte value)
    {
        CodecUtil.charPut(buffer, offset + 5, value);
        return this;
    }
}
